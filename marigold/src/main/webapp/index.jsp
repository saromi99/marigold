...
<body>
	...
	<div id="container">
		...
		<form method="get" action="checkBoxList.do">
			<p>성별 및 연령</p>
			<input type="checkbox" name="firstCategory" value="1" />남성 <input
				type="checkbox" name="firstCategory" value="2" />여성 <input
				type="checkbox" name="firstCategory" value="3" />남녀공용 <input
				type="checkbox" name="firstCategory" value="4" />키즈

			<p>신발 종류</p>
			<input type="checkbox" name="secondCategory" value="1" />운동화 <input
				type="checkbox" name="secondCategory" value="2" />스포츠 <input
				type="checkbox" name="secondCategory" value="3" />구두 <input
			...
			<input type="checkbox" name="material" value="01" />소가죽 <input
				...
				type="checkbox" name="material" value="11" />EVA/고무 <input
				type="checkbox" name="material" value="12" />면/코튼 <input
				type="checkbox" name="material" value="13" />레이온


			<p>브랜드</p>
			<input type="checkbox" name="brand" value="001" />샤넬 <input
				type="checkbox" name="brand" value="002" />셀린느 <input
				type="checkbox" name="brand" value="003" />멀버리 <input
				type="checkbox" name="brand" value="004" />버버리 <input
				type="checkbox" name="brand" value="005" />메종마르지엘라 <input
				type="checkbox" name="brand" value="006" />벨루티 <input
				type="checkbox" name="brand" value="007" />발리 <input
				type="checkbox" name="brand" value="008" />발망 <input
				type="checkbox" name="brand" value="009" />페레가모 <input
				type="checkbox" name="brand" value="010" />루이비통 <input
				type="checkbox" name="brand" value="011" />구찌 <input
				type="checkbox" name="brand" value="012" />디올 <input
				type="checkbox" name="brand" value="013" />지방시 <input
				type="checkbox" name="brand" value="014" />빈폴 <input
				type="checkbox" name="brand" value="015" />폴로 <input
				type="checkbox" name="brand" value="016" />랄프로렌 <input
				...
				type="checkbox" name="brand" value="030" />리복 <input
				type="checkbox" name="brand" value="031" />아키클래식 <input
				type="checkbox" name="brand" value="032" />캐치볼 <input
				type="checkbox" name="brand" value="033" />닥터마틴 <input
				type="checkbox" name="brand" value="034" />팀버랜드 <input
				type="checkbox" name="brand" value="035" />프레드페리 <input
				type="checkbox" name="brand" value="036" />스케쳐스 <input
				type="checkbox" name="brand" value="037" />푸마 <input
				type="checkbox" name="brand" value="038" />포즈간츠 <input
				type="checkbox" name="brand" value="039" />스테파노로시 <input
				type="checkbox" name="brand" value="040" />마크모크 <input
				type="checkbox" name="brand" value="041" />버켄스탁 <input
