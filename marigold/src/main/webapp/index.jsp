...
<body>
	...
	<div id="container">
		...
		<form method="get" action="#">
			<p>성별 및 연령</p>
			<input type="checkbox" name="firstCategory" value="1" />남성
			<input type="checkbox" name="firstCategory" value="2" />여성
			<input type="checkbox" name="firstCategory" value="3" />남녀공용
			<input type="checkbox" name="firstCategory" value="4" />키즈
		</form>
		...
		<form method="get" action="#">
			...
			<input type="checkbox" name="secondCategory" value="3" />구두
			<input type="checkbox" name="secondCategory" value="4" />샌들
			<input type="checkbox" name="secondCategory" value="5" />캐주얼
			<input type="checkbox" name="secondCategory" value="6" />부츠
		</form>

		<form method="get" action="#">
			<p>스타일</p>
			<input type="checkbox" name="thirdCategory" value="01" />캔버스화
			<input type="checkbox" name="thirdCategory" value="02" />스니커즈
			<input type="checkbox" name="thirdCategory" value="03" />슬립온
			<input type="checkbox" name="thirdCategory" value="04" />어글리슈즈
			<input type="checkbox" name="thirdCategory" value="05" />커스텀
			<input type="checkbox" name="thirdCategory" value="06" />런닝화
			<input type="checkbox" name="thirdCategory" value="07" />농구화
			<input type="checkbox" name="thirdCategory" value="08" />골프화
			<input type="checkbox" name="thirdCategory" value="09" />등산화
			<input type="checkbox" name="thirdCategory" value="10" />기능화
			<input type="checkbox" name="thirdCategory" value="11" />축구화
			<input type="checkbox" name="thirdCategory" value="12" />로퍼/플랫
			<input type="checkbox" name="thirdCategory" value="13" />힐/펌프스
			<input type="checkbox" name="thirdCategory" value="14" />슬링백/토오픈
			<input type="checkbox" name="thirdCategory" value="15" />뮬/블로퍼
			<input type="checkbox" name="thirdCategory" value="16" />레이스업
			<input type="checkbox" name="thirdCategory" value="17" />슬라이드
			<input type="checkbox" name="thirdCategory" value="18" />아쿠아슈즈
			<input type="checkbox" name="thirdCategory" value="19" />스포츠샌들
			<input type="checkbox" name="thirdCategory" value="20" />코르크샌들
			<input type="checkbox" name="thirdCategory" value="21" />레더샌들
			<input type="checkbox" name="thirdCategory" value="22" />드레스샌드
			<input type="checkbox" name="thirdCategory" value="23" />슬리퍼
			<input type="checkbox" name="thirdCategory" value="24" />워킹슈즈
			<input type="checkbox" name="thirdCategory" value="25" />워커부츠
			<input type="checkbox" name="thirdCategory" value="26" />패딩부츠
			<input type="checkbox" name="thirdCategory" value="27" />첼시부츠
			<input type="checkbox" name="thirdCategory" value="28" />미들부츠
			<input type="checkbox" name="thirdCategory" value="29" />롱부츠
			<input type="checkbox" name="thirdCategory" value="30" />레인부츠
			<input type="checkbox" name="thirdCategory" value="31" />어그부츠
			<input type="checkbox" name="thirdCategory" value="32" />앵클부츠
		</form>

		<form method="get" action="#">
			<p>재질</p>
			<input type="checkbox" name="material" value="01" />소가죽
			<input type="checkbox" name="material" value="02" />송아지가죽
			<input type="checkbox" name="material" value="03" />인조가죽/합성피혁
			<input type="checkbox" name="material" value="04" />스웨이드
			<input type="checkbox" name="material" value="05" />나일론
			<input type="checkbox" name="material" value="06" />패브릭
			<input type="checkbox" name="material" value="07" />악어가죽
			<input type="checkbox" name="material" value="08" />양가죽
			<input type="checkbox" name="material" value="09" />데님
			<input type="checkbox" name="material" value="10" />에나멜
			<input type="checkbox" name="material" value="11" />EVA/고무
			<input type="checkbox" name="material" value="12" />면/코튼
			<input type="checkbox" name="material" value="13" />레이온
		</form>
